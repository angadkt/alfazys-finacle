...
export default function LandingPage() {
 ...
 return (
 <div className="h-screen bg-white text-slate-900 flex flex-col antialiased relative selection:bg-[#9e0248]/10 selection:text-[#9e0248] overflow-hidden">
 ...
 {/* Hero Section */}
 <section className="flex-1 flex flex-col justify-center items-center max-w-5xl mx-auto px-0.5 text-center relative z-10 select-none pb-8">
 ...
 {/* CTA Actions */}
 <div className="mt-10 flex justify-center items-center w-full opacity-0 animate-[fadeIn_0.8s_ease-out_0.4s_forwards]">
 <button 
 onClick={() => navigate('/login')}
